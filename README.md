...
The goal is to keep a fast, searchable, and practical reference for my future self while sharing knowledge with the open-source community.
...
```markdown
---
title: "Short, descriptive title of the command/concept"
date: YYYY-MM-DD
category: "Technology"
tags: ["tag1", "tag2"]
---
...
Context or problem statement goes here.

### The Code / Command
\`\`\`bash
# The exact command or snippet
\`\`\`
